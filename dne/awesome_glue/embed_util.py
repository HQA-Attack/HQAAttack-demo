from dne.allennlpx.modules.token_embedders.embedding import \
    _read_embeddings_from_text_file
from dne.luna import (LabelSmoothingLoss, auto_create)
from allennlp.data.vocabulary import Vocabulary
from dne.allennlpx.modules.token_embedders.embedding import VanillaEmbedding
...
from dne.allennlpx.interpret.attackers.searchers import EmbeddingNbrUtil
...
WORD2VECS = {
    ...
    maybe_path("/disks/sdb/zjiehang/embeddings/glove/glove.42B.300d.txt",
               "/home/xuzhi/senior/ad/glove.42B.300d.txt",
