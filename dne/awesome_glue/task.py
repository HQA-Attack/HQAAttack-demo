...
from dne.allennlpx.training.adv_trainer import AdvTrainer
...
from dne.awesome_glue.utils import (AttackMetric, set_environments, WarmupCallback,
                                text_diff, read_hyper,
                                allen_instances_for_attack)
from dne.luna import flt2str, ram_write, ram_set_flag, ram_reset_flag
from dne.luna.logging import log
from dne.luna.public import Aggregator, auto_create, numpy_seed
from dne.luna.pytorch import set_seed
from allennlp.training.metrics.categorical_accuracy import CategoricalAccuracy
from dne.allennlpx.training.checkpointer import CheckpointerX
from dne.allennlpx.training import adv_utils
import logging
from dne.awesome_glue.data_loader import load_banned_words, load_data
from dne.awesome_glue.weighted_util import WeightedHull, SameAlphaHull, DecayAlphaHull
from dne.awesome_glue.biboe import BiBOE
from dne.awesome_glue.decom_att import DecomposableAttention
from dne.awesome_glue.weighted_embedding import WeightedEmbedding
...
class Task:
    ...
    def from_pretrained(self):
        # ckpt_path = f'saved/models/{self.config.model_name}-hot.3.0.15'
        ckpt_path = f'dne/saved/models/{self.config.model_name}'
